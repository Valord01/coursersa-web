				...
				<div id="home" class="slider">
					<div id="main_slider" class="carousel slide" data-ride="carousel">
						<ol class="carousel-indicators">
							<li data-target="#main_slider" data-slide-to="0" class="active"/>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="item">
									...
									<p>
										<img style="height: 24px; width:24px; margin-top: -3px;" src="imgs/navi.png" alt="#"/>
										<strong> Main office Address:</strong>
									</p>
									<p>  H.No 126 Panaji Bardez 403507 Goa</p>
									<p>
										<img style="height: 22px; width:22px; margin-top: -3px;" src="imgs/phone.png" alt="#"/>
									</p>
									<p>
